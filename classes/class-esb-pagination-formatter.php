...
class Esb_Pagination_Formatter {
    ...
    public function __construct(private WP_Query $query, private Esb_Html_Helper $html_helper, int $max_pag_links = 4) {
        /**
         * @param WP_Query          $query              Reference to the current query
         * @param Esb_Html_Helper   $html_helper        Instance of the HTML helper class to assist with formatting
